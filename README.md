...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
   Semantic HTML provides meaning to the web page similar to a skeleton of the design

2. Name two big differences between ```display: block;``` and ```display: inline;```.
   Inline block allows to set a width and height to the element.  Display:inline does not respect top and bottom margin and padding.
...
5. Explain why git is valuable to a team of developers.
   Because it allows developers to collaborate on the same project at the same time while pushing changes periodically
